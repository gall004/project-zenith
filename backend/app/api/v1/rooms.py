"""Room token generation endpoint (US-01).

Generates LiveKit access tokens for WebRTC voice/video sessions.
Pipeline spawning has been decoupled — the Pipecat media pipeline
will be activated separately in a future media-routing sprint.
"""
...
async def create_token(request: TokenRequest):
    """Generate a secure AccessToken for the LiveKit server (US-01)."""
